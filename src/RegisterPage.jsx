    ...
    <div className='bg-[#fafafa] h-dvh w-full flex items-center justify-center'>
      <div className='bg-white p-6 rounded-3xl'>
        <div className='mb-4'>
          ...
          <small className='text-[12px] font-bold text-[#424242be]'>Sign up for Formix</small>
        </div>
        ...
        <form>
          <div className='flex flex-col mb-[10px]'>
            <label htmlFor="fullName" className='text-[10px] font-bold mb-[3px]'>
              Full Name
            </label>
            <input type="text" className='border-2 rounded-[3px] py-1 px-3 text-[12px] font-bold text-[#3d3d3d8e]'/>
          </div>
          <div className='flex flex-col mb-[10px]'>
          ...
          <div className='flex items-center gap-1 mb-5'>
            ...
            <small className='text-[11px]'>I agree to the <b className='text-black'>Privacy Policy</b> and <b className='text-black'>Terms of Service</b></small>
          </div>
          <button className='w-full bg-black text-[#fcfcfcf8] rounded text-[12px] p-[9px] font-semibold mb-5'>Create Account</button>
        </form>
        <p className='text-[11px] text-center text-[#1f1f1f9c] font-bold'>Have an account already? <b className='text-black'>
          <Link to='/loginPage'> Log In</Link></b>
        </p>
      </div>
    </div>
  )
